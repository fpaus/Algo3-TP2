...
public class JuegoViewEstadoFaseSetUnidades implements JuegoViewEstado {

    @Override
    public void cambiarAModoSeleccionDeUnidad(HashMap<Coordenada, CasilleroView> casillerosView, Juego juego) {
        casillerosView.forEach((coordenada, casilleroView) -> casilleroView.cambiarSetOnMouseClickedAaccionPasiva());
