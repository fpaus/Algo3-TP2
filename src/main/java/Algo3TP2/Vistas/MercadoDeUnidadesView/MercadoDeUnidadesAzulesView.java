...
public class MercadoDeUnidadesAzulesView extends MercadoDeUnidadesView {
    ...
    public MercadoDeUnidadesAzulesView(Bando bando, Juego juego) throws CasilleroFueraDelLosLimitesDelTableroExcepcion {
        ...
        botonUnidad1.setGraphic(new ImageView(new Image("file:src/resources/Mercado/boton_comprar_soldado_azul.png")));
        botonUnidad1.setOnAction(new ComprarUnidadHandler(colorEquipo, "Soldado", bando, juego));

        Button botonUnidad2 = new Button();
        botonUnidad2.setGraphic(new ImageView(new Image("file:src/resources/Mercado/boton_comprar_jinete_azul.png")));
        botonUnidad2.setOnAction(new ComprarUnidadHandler(colorEquipo, "Jinete", bando, juego));

        Button botonUnidad3 = new Button();
        botonUnidad3.setGraphic(new ImageView(new Image("file:src/resources/Mercado/boton_comprar_curandero_azul.png")));
        botonUnidad3.setOnAction(new ComprarUnidadHandler(colorEquipo, "Curandero", bando, juego));

        Button botonUnidad4 = new Button();
        botonUnidad4.setGraphic(new ImageView(new Image("file:src/resources/Mercado/boton_comprar_catapulta_azul.png")));
